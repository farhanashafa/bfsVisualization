...
public class CanvasView extends View {
    ...
    public final Paint emptyPaint = new Paint();
    ...
    // for Paint
    public Paint.Style paintStyle = Paint.Style.STROKE;
    ...
    // for Text
    public String text           = "";
    public Typeface fontFamily   = Typeface.DEFAULT;
    public float fontSize        = 32F;
    public Paint.Align textAlign = Paint.Align.RIGHT;  // fixed
